...
struct LoginView: View {
    ...
    func login() {
        ...
        /* var userprofile = dbService.createUserProfile(email: self.userEmail, sex:"" bodyweight:  , maxBench: <#T##Double#>, maxSquat: <#T##Double#>, maxDeadlift: <#T##Double#>, maxOHP: <#T##Double#>)
